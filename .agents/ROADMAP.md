...
| 6   | **Validate**                                    | `/validate` (generated by `/ultimate_validate_command` after Task 01) | All checks green                |
...
- After the scaffold exists, run `/ultimate_validate_command` to generate `.claude/commands/validate.md`.
